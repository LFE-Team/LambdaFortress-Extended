...
#define	CREMATORRED_MAX_BEAMS	1
#define	CREMATORRED_MAX_NOISE	12
...
//=========================================================
//=========================================================
class CNPC_CrematorRed : public CAI_BaseNPC //CHL1BaseNPC by Default
{
...
private:
	...
	CBeam *m_pBeam[CREMATORRED_MAX_BEAMS];
	CBeam *m_hNoise[CREMATORRED_MAX_NOISE];
