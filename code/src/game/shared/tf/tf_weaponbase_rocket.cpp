...
#ifdef GAME_DLL
ConVar tf2c_homing_rockets( "lfe_homing_rockets", "0", FCVAR_CHEAT, "What is \"Rocket + x = Death\"?" );
ConVar tf2c_homing_deflected_rockets( "lfe_homing_deflected_rockets", "0", FCVAR_CHEAT, "Homing Crit Rockets 2: Back with Vengeance" );
#endif
