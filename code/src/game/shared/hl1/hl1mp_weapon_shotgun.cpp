...
class CWeaponHL1Shotgun : public CBaseHL1MPCombatWeapon
{
	DECLARE_CLASS( CWeaponHL1Shotgun, CBaseHL1MPCombatWeapon );
...
LINK_ENTITY_TO_CLASS( weapon_shotgun_hl1, CWeaponHL1Shotgun );
