...
#include "lfe_createmultiplayergamebotpage.h"
...
//-----------------------------------------------------------------------------
void CTFCreateMultiplayerGameBotPage::SetJoinTeamCombo( const char *team )
{
	if (team)
	{
...
//-----------------------------------------------------------------------------
void CTFCreateMultiplayerGameBotPage::SetChatterCombo( const char *chatter )
{
	if (chatter)
	{
...
// Constructor
//-----------------------------------------------------------------------------
CTFCreateMultiplayerGameBotPage::CTFCreateMultiplayerGameBotPage( vgui::Panel *parent, const char *name, KeyValues *botKeys ) : CTFDialogPanelBase( parent, name )
{
...
// Destructor
//-----------------------------------------------------------------------------
CTFCreateMultiplayerGameBotPage::~CTFCreateMultiplayerGameBotPage()
{
...
// Reset values
//-----------------------------------------------------------------------------
void CTFCreateMultiplayerGameBotPage::OnResetChanges()
{
}
...
//-----------------------------------------------------------------------------
void CTFCreateMultiplayerGameBotPage::OnApplyChanges()
{
