...
class C_RollerMineRed : public C_AI_BaseNPC
{
	DECLARE_CLASS( C_RollerMineRed, C_AI_BaseNPC );
public:
	DECLARE_CLIENTCLASS();

			C_RollerMineRed( void ) {}
...
private:
	C_RollerMineRed( const C_RollerMineRed & ) {}
...
IMPLEMENT_CLIENTCLASS_DT( C_RollerMineRed, DT_RollerMineRed, CNPC_RollerMineRed )
...
// Output : int
//-----------------------------------------------------------------------------
int C_RollerMineRed::DrawModel( int flags )
{
